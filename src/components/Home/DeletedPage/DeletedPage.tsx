...
import { fetchDeleteFiles, fetchGetAmountData, fetchGetDeletedFiles } from '../../../store/FoldersSlice';
    ...
    return (
      <section className={style.wrapper}>
        ...
        <div className={style.box}>
          ...
          <button onClick={() => appDispatch(fetchDeleteFiles({username, deletedFiles})).then(() => appDispatch(fetchGetAmountData(username)))} className={style.delAll} >
            Delete All <img className={style.linkImg} src={deleteFolder} alt="all" />
          </button>
        </div>
