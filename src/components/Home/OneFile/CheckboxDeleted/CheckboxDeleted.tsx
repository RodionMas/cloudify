...
import { changeDeleteSelected, deleteSelected } from '../../../../store/deleteSlise';
import { selectDelete } from '../../../../selectors/selectors';
...
const CheckboxDeleted: React.FC<FileType> = ({ filename, filePath, }) => {
    ...
    return (
        ...
        onChange={() => {
            ...
            if (!isChecked) { //условие наоброт, тут checked = true
